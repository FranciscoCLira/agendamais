...
/**
 * DTO para representar um registro de inscrição da planilha Excel do Microsoft Forms
 * Colunas: G-O (email, nome, celular, identificacaoPessoaInstituicao, identificacaoPessoaSubInstituicao, cidade, estado, pais, comentarios)
 */
