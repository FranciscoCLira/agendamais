...
public interface OcorrenciaAtividadeRepository
        ...
        boolean existsByIdAutorId(Long idAutorId);
        ...
        @Query("SELECT DISTINCT o.assuntoDivulgacao FROM OcorrenciaAtividade o WHERE LOWER(o.assuntoDivulgacao) LIKE LOWER(CONCAT('%', :term, '%')) ORDER BY o.assuntoDivulgacao")
