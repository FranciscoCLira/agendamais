...
public class PessoaInstituicao implements Serializable {
	...
	@Column(length = 20)
	private String indicaPessoaAfiliadaInstituicao;
	...
	public String getIndicaPessoaAfiliadaInstituicao() {
		return indicaPessoaAfiliadaInstituicao;
	}

	public void setIndicaPessoaAfiliadaInstituicao(String indicaPessoaAfiliadaInstituicao) {
		this.indicaPessoaAfiliadaInstituicao = indicaPessoaAfiliadaInstituicao;
	}
